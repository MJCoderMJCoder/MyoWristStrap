...
Java_com_lzf_myowriststrap_jni_MTCNN_FaceDetectionModelInit(JNIEnv *env, jobject instance,
...
Java_com_lzf_myowriststrap_jni_MTCNN_FaceDetect(JNIEnv *env, jobject instance,
...
JNIEXPORT jintArray JNICALL
Java_com_lzf_myowriststrap_jni_MTCNN_MaxFaceDetect(JNIEnv *env, jobject instance,
                                                   jbyteArray imageDate_,
                                                   jint imageWidth, jint imageHeight,
                                                   jint imageChannel) {
    //  LOGD("JNI开始检测人脸");
...
JNIEXPORT jboolean JNICALL
Java_com_lzf_myowriststrap_jni_MTCNN_FaceDetectionModelUnInit(JNIEnv *env, jobject instance) {
    if (!detection_sdk_init_ok) {
...
JNIEXPORT jboolean JNICALL
Java_com_lzf_myowriststrap_jni_MTCNN_SetMinFaceSize(JNIEnv *env, jobject instance, jint minSize) {
    if (!detection_sdk_init_ok) {
...
JNIEXPORT jboolean JNICALL
Java_com_lzf_myowriststrap_jni_MTCNN_SetThreadsNumber(JNIEnv *env, jobject instance,
                                                      jint threadsNumber) {
    if (!detection_sdk_init_ok) {
        LOGD("人脸检测MTCNN模型SDK未初始化，直接返回");
        return false;
...
JNIEXPORT jboolean JNICALL
Java_com_lzf_myowriststrap_jni_MTCNN_SetTimeCount(JNIEnv *env, jobject instance, jint timeCount) {
