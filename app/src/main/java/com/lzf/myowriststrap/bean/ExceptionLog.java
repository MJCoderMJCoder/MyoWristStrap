...
public class ExceptionLog implements Serializable {
     ...
     */
    @NotNull
    private String exceptionLogClass;
     ...
     */
    @NotNull
    private String exceptionLogDateTime;
    ...
    public String getExceptionLogClass() {
        return this.exceptionLogClass;
    }

    public void setExceptionLogClass(String exceptionLogClass) {
        this.exceptionLogClass = exceptionLogClass;
    }

    public String getExceptionLogMethod() {
        return this.exceptionLogMethod;
    }
    ...
    public String getExceptionLogMessage() {
        return this.exceptionLogMessage;
    }
    ...
    public String getExceptionLogDateTime() {
        return this.exceptionLogDateTime;
    }

    public void setExceptionLogDateTime(String exceptionLogDateTime) {
        this.exceptionLogDateTime = exceptionLogDateTime;
    }
}
