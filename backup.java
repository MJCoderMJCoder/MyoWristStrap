...
public class MainActivity extends AppCompatActivity {
    ...
    //休息时的第一个Orientation
    private Orientation restFirstOrientation = null;
    //点赞时的最后一个Orientation
    ...
    private DeviceListener deviceListener = new AbstractDeviceListener() {
         ...
         * 纸纷飞提供：点赞、菜鸟、手枪、爱你、胜利、极客、666、NO、比心。
         * @param myo
         * @param timestamp
         * @param rotation
         */
        ...
        public void onOrientationData(Myo myo, long timestamp, Quaternion rotation) {
            try {
                ...
                switch (myo.getPose()) {
                    ...
                    case DOUBLE_TAP:
                        restFirstOrientation = null;
                        imageView.setImageResource(R.drawable.double_tap);
                        armStr += " - 双击";  //双发快射、双击。大拇指和中指相互连续碰两下。
                        sampleText.setText(armStr);
                    ...
                    case FINGERS_SPREAD:
                        ...
                        if (fingersSpreadOrientationList.size() <= 30) {
                            ...
                            fingersSpreadOrientationList.clear();
                        }
                        break;
                }
